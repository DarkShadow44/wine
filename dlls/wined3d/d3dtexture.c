...
static wined3d_dxtn_conversion_func wined3d_get_dxtn_conversion_func(D3DFORMAT format, BOOL encode)
{
    switch (format)
    {
        case D3DFMT_DXT1:
...
static HRESULT wined3d_convert_memory_to_rgba(int width, int height, const void *src_memory, void *dst_memory,
        D3DFORMAT src_format, UINT src_pitch, const PALETTEENTRY *src_palette, D3DCOLOR color_key)
{
