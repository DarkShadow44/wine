...
void wine_thunk_initialize_kernelbase(void)
{
	...
	pkernelbase_GetCurrentProcess = (void *)GetProcAddress(library, "kernelbase_GetCurrentProcess");
	pkernelbase_GetCurrentProcessId = (void *)GetProcAddress(library, "kernelbase_GetCurrentProcessId");
	...
	pkernelbase_GetCurrentThread = (void *)GetProcAddress(library, "kernelbase_GetCurrentThread");
	pkernelbase_GetCurrentThreadId = (void *)GetProcAddress(library, "kernelbase_GetCurrentThreadId");
	...
	pkernelbase_GetLastError = (void *)GetProcAddress(library, "kernelbase_GetLastError");
	...
	pkernelbase_GetProcessHeap = (void *)GetProcAddress(library, "kernelbase_GetProcessHeap");
	...
	pKERNELBASE_lstrcpynA = (void *)GetProcAddress(library, "KERNELBASE_lstrcpynA");
	pKERNELBASE_lstrcpynW = (void *)GetProcAddress(library, "KERNELBASE_lstrcpynW");
	pKERNELBASE_lstrlenA = (void *)GetProcAddress(library, "KERNELBASE_lstrlenA");
	pKERNELBASE_lstrlenW = (void *)GetProcAddress(library, "KERNELBASE_lstrlenW");
	initialized = TRUE;
}
