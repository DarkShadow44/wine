...
wine_patch_data[] =
{
    ...
    { "Sebastian Lackner", "ntdll: Allow to release threadpool objects while waiting for group.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Call group cancel callback with the correct arguments.", 1 },
    { "Sebastian Lackner", "ntdll: Do not allow to deallocate thread stack for current thread.", 1 },
    { "Sebastian Lackner", "ntdll: Do not call group cancel callback for finished simple callbacks.", 2 },
    ...
    { "Sebastian Lackner", "ntdll: Group cancel callbacks should be executed after waiting for pending callbacks.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add tests for releasing threadpool objects during TpReleaseCleanupGroupMembers.", 1 },
    { "Sebastian Lackner", "ntdll/tests: Use longer waits to reduce risk of random failures on the testbot.", 1 },
    ...
    { "Sebastian Lackner", "server: Workaround duplicate condition warning of GCC 6.", 1 },
    { "Sebastian Lackner", "services: Remove synchronization for CloseThreadpoolCleanupGroupMembers.", 1 },
